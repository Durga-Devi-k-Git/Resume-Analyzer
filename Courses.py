...
web_job=[['Apply Web Development Related Jobs in Linkedin','http://www.linkedin.com/jobs/search/?keywords=web+developer&&software+engineer&&software+developer&&frontend+developer&&backend+developer&&fullstack+developer'],
         ['Apply Web Development Related Jobs in Indeed','https://www.indeed.com/jobs?q=web+developer,software+engineer,software+developer,frontend+developer,backend+developer,fullstack+developer']
        ]
ds_job=[['Apply Data Scientist Related Jobs in Linkedin','http://www.linkedin.com/jobs/search/?keywords=data+scientist&&data+analyst'],
        ['Apply Data Scientist Related Jobs in Indeed','https://www.indeed.com/jobs?q=data+scientist,data+analyst']  
        ]
uiux_job=[['Apply UI/UX Developer Related Jobs in Linkedin','http://www.linkedin.com/jobs/search/?keywords=uiux+developer&&uiux+designer'],
          ['Apply UI/UX Developer Related Jobs in Indeed','https://www.indeed.com/jobs?q=uiux+scientist,uiux+designer']
        ]
ios_job=[['Apply IOS Development Related Jobs in Linkedin','http://www.linkedin.com/jobs/search/?keywords=ios+developer&&mobile+engineer&&iphone+developer'],
        ['Apply IOS Development Related Jobs in Indeed','https://www.indeed.com/jobs?q=ios+developer,mobile+engineer,iphone+developer'] 
        ]
android_job=[['Apply Android Developer Related Jobs in Linkedin','http://www.linkedin.com/jobs/search/?keywords=android+developer&&mobileapp+developer'],
        ['Apply Android Developer Related Jobs in Indeed','https://www.indeed.com/jobs?q=android+developer,mobileapp+developer'] 
        ]